...
namespace ForumSiteCore.Web.Migrations
{
    ...
    [Migration("20170920031723_InitialSiteModels")]
    partial class InitialSiteModels
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ForumSiteCore.Web.Data.Models.Comment", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("ForumSiteCore.Web.Data.Models.CommentSave", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("ForumSiteCore.Web.Data.Models.CommentVote", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("ForumSiteCore.Web.Data.Models.Forum", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("ForumSiteCore.Web.Data.Models.ForumSave", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("ForumSiteCore.Web.Data.Models.Post", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("ForumSiteCore.Web.Data.Models.PostSave", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("ForumSiteCore.Web.Data.Models.PostVote", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("ForumSiteCore.Web.Data.Models.Comment", b =>
                {
                    b.HasOne("ForumSiteCore.Web.Data.Models.Comment", "Parent")
                        .WithMany()
                        .HasForeignKey("ParentId")
                        .HasConstraintName("fk_comments_comments_parent_id")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("ForumSiteCore.Web.Data.Models.Post", "Post")
                        .WithMany()
            ...
            modelBuilder.Entity("ForumSiteCore.Web.Data.Models.CommentSave", b =>
                {
                    b.HasOne("ForumSiteCore.Web.Data.Models.Comment", "Comment")
                        .WithMany("CommentSaves")
                        .HasForeignKey("CommentId")
                        .HasConstraintName("fk_comment_saves_comments_comment_id")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("ForumSiteCore.Web.Data.Models.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("ForumSiteCore.Web.Data.Models.ForumSave", b =>
                {
                    b.HasOne("ForumSiteCore.Web.Data.Models.Forum", "Forum")
                        .WithMany("ForumSaves")
